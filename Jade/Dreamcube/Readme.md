...
The screen glitches. For a moment, the text renders in a different font. The background shifts to something resembling your blog template. Then it stabilizes, but the voice has changed.
...
Status: Documentation recognized. Bridge building in progress.
